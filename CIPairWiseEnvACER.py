...
class CIPairWiseEnvACER(gym.Env):
    def __init__(self, cycle_logs: CICycleLog, conf: Config):
        super(CIPairWiseEnvACER, self).__init__()
        ...
        self.observation_space = spaces.Box(low=0, high=1, shape=(2, self.testcase_vector_size,1))
    ...
    def get_pair_data(self, current_indexes):
        ...
        return np.reshape(temp_obs,(temp_obs.shape[0],temp_obs.shape[1],1))
